...
void main() {
  ...
  test('Convert HEX [255, 255, 255] to RGB #FFFFFF', () {
    ...
    expect(res, '#1E0900');
          ...
          test('Convert HEX [1, 2, 3] to RGB #010203', () {
    final res = colorConverter.rgbToHex([1, 2, 3]);
    expect(res, '#010203');
  });

          test('Convert HEX [0,0,0] to RGB #000000', () {
    final res = colorConverter.rgbToHex([0,0,0]);
    expect(res, '#000000');
  });
}
